...
namespace EncryptionApp
{
    ...
    {
#if DEBUG
#warning Remove Debug Button
        //private void testDebugButton_Click(object sender, EventArgs e)
        //{
        //    MessageBox.Show("No Debug message to log.", "Debug Window", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //}
#endif
        private bool resultIsSaved = false;
		private string encryptionResult = "null";
		private Thread encryptionThread = null;
